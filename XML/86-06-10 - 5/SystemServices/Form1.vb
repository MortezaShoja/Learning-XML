...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnStop
        '
        Me.btnStop.Location = New System.Drawing.Point(320, 16)
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim s() As ServiceProcess.ServiceController = sc.GetServices
        For i As Integer = 0 To s.Length - 1
            lst.Items.Add(s(i).ServiceName)
        Next
    End Sub

    Private Sub btnStop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStop.Click
        Dim scontroller As New ServiceProcess.ServiceController(lst.SelectedItem)
        If scontroller.Status <> ServiceProcess.ServiceControllerStatus.Stopped And scontroller.CanStop Then
            scontroller.Stop()
        Else
            MsgBox("Impossible!")
        End If
